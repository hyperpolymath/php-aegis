...
// Replace php-aegis, php-aegis, {{DEPS}} with actuals
= php-aegis — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining php-aegis for
...
| `$PREFIX/share/php-aegis/`
| Data files, assets

| `$PREFIX/share/doc/php-aegis/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/php-aegis/config.toml`

Fallback: `$HOME/.config/php-aegis/config.toml`
...
Or via OPSM: `opsm update php-aegis`
...
[source,bash]
----
just install --prefix=/opt/php-aegis-instance1 --config=/etc/php-aegis/instance1.toml
just install --prefix=/opt/php-aegis-instance2 --config=/etc/php-aegis/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/php-aegis/issues
