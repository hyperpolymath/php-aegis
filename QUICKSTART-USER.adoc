...
// Replace php-aegis, Php Aegis — See README.adoc for details., just run, Php Aegis started successfully. with actuals
= php-aegis — Quick Start for Users
:toc:
:toclevels: 2

== What is php-aegis?

Php Aegis — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./php-aegis-portable
----
...
[source]
----
Php Aegis started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/php-aegis/wiki
